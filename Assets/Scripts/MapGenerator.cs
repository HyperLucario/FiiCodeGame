...
public class MapGenerator : MonoBehaviour {
	...
	public void GenerateMap() {
		...
		if (drawMode == DrawMode.NoiseMap) {
			render.DrawTexture (TextureGenerator.TextureFromHeightMap(noiseMap));
		} else if (drawMode == DrawMode.ColourMap) {
			render.DrawTexture (TextureGenerator.TextureFromColourMap(colourMap, mapWidth, mapHeight));
		}
